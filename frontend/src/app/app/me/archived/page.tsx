...
export default async function Page() {
  ...
  const archived = me.events.filter((event) => event.isArchived === true);

  const myArchived = me.myEvents.filter((event) => event.isArchived === true);
  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContainer}>
        <Archived
          archived={archived as T_EventData[]}
          myArchived={myArchived as T_EventData[]}
        />
      </main>
    </div>
  );
